...
<head>
	<meta charset="utf-8">
	<title>Shopper.com - Contact Us!</title>
...
<body>
	<div id="wrapper" class="container">
		...
		<section class="google_map">
			<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d7352.240320343311!2d91.0915135!3d22.8720192!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1645643435919!5m2!1sen!2sbd" width="1150" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
		</section>
				...
				<div class="span5">
					<div>
						...
						<p><strong>Phone:</strong>&nbsp;(123) 456-7890<br>
							...
							<strong>Email:</strong>&nbsp;<a href="#">sajidhossainhemal@gmail.com</a>
						</p>
						<br />
						<h5>SECONDARY OFFICE IN NOAKHALI</h5>
						<p><strong>Phone:</strong>&nbsp;(113) 023-1125<br>
							<strong>Fax:</strong>&nbsp;+04 (113) 023-1145<br>
							<strong>Email:</strong>&nbsp;<a href="#">tawhidahmed98@gmail.com</a>
						</p>
					</div>
				</div>
				<div class="span7">
					...
					<form method="post" action="connect.php">
						<fieldset>
							...
							<div class="clearfix">
								...
								<div class="input">
									<input tabindex="1" size="18" id="phoneNumber" name="phoneNumber" type="text" value="" class="input-xlarge" placeholder="Phone Number">
								</div>
							</div>
							...
							<div class="clearfix">
								...
								<div class="input">
									<input tabindex="1" size="18" id="address" name="address" type="text" value="" class="input-xlarge" placeholder="Address">
								</div>
							</div>
							...
							<div class="clearfix">
								...
								<div class="input">
									<textarea tabindex="3" id="message" name="message" rows="7" placeholder="Message" class="input-xlarge"></textarea>
								</div>
							</div>
